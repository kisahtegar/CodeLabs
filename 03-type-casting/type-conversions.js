...
// right type. For example, alert automatically converts any value to a string to show it. Mathematical
// operations convert values to numbers. There are also cases when we need to explicitly convert a
...
// * Boolean Conversion *
//
// Boolean conversion is the simplest one. It happens in logical operations (later we’ll meet
// condition tests and other similar things) but can also be performed explicitly with a call
// to Boolean(value).
