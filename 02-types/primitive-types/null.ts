...
// * null *
//
// JavaScript has two primitive values used to signal absent or uninitialized value: null (absent)
// and undefined (unintialized).
//
...
// tends to be a major source of bugs; TypeScript always recommend people turn strictNullChecks on
// if it’s practical to do so in the codebase.
//
...
function doSomethings(x: string | null) {
  if (x === null) {
    // do nothing
  } else {
